<?php if(!function_exists('newstack_frontpage_editor_post_section')):
...
*
*/
  function newstack_frontpage_editor_post_section()
    {
...
add_action('newstack_action_front_page_editor_section', 'newstack_frontpage_editor_post_section', 30);

//Front Page Banner
if (!function_exists('newstack_front_page_banner_section')) :
    /**
     *
     * @since newstack
     *
     */
    function newstack_front_page_banner_section()
    {
        if (is_front_page() || is_home()) {
            ...
            <div class="overlay">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <?php do_action('newstack_action_banner_tabbed_posts');?>
                        <div class="col-md-6">
                            <div id="homemain"class="homemain owl-carousel mr-bot60"> 
                                <?php newsup_get_block('list', 'banner'); ?>
                            </div>
                        </div> 
                        <?php do_action('newstack_action_front_page_editor_section');?>
...
add_action('newstack_action_front_page_main_section_1', 'newstack_front_page_banner_section', 40);



//Banner Tabed Section
if (!function_exists('newstack_banner_tabbed_posts')):
    /**
     *
     * @since newstack 1.0.0
     *
     */
    function newstack_banner_tabbed_posts()
    {
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#<?php echo esc_attr($tab_id); ?>-recent"
                               aria-controls="<?php esc_attr_e('Recent', 'newstack'); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#<?php echo esc_attr($tab_id); ?>-popular"
                               aria-controls="<?php esc_attr_e('Popular', 'newstack'); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#<?php echo esc_attr($tab_id); ?>-categorised"
                               aria-controls="<?php esc_attr_e('Categorised', 'newstack'); ?>">
...
add_action('newstack_action_banner_tabbed_posts', 'newstack_banner_tabbed_posts', 10);